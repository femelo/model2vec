...
from model2vec.train.classifier import StaticModelForClassification, StaticEnsembleModelForClassification

__all__ = ["StaticModelForClassification", "StaticEnsembleModelForClassification"]
